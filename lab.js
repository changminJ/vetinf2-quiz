...
{id:46, part:'RNA추출', topic:'Spin column 전체 protocol 영어 순서', origin:'jokbo', type:'essay',
 ...
 exam:'2025-기말', hl2025:true, freq:1, source:'jokbo'},
{id:47, part:'RNA추출', topic:'영어 단계에서 cation bridge·공회전 고르기', origin:'jokbo', type:'multi',
 q:`다음은 spin column RNA 추출 protocol의 **영어 단계**다. 이 중 **cation bridge가 형성되어 핵산이 silica membrane에 흡착되는 데 직접 관여하는 단계**를 모두 고르시오. (2025 기말 — 영어 선지에서 특징 단계 고르기)`,
 ...
 answer:[2,3],
 explain:`**정답: ②③ (Binding Buffer 첨가 + Load·centrifuge)**\n\n- ② **Add Binding Buffer** = high salt 조성 → Na⁺ **cation bridge 형성 시작**.\n- ③ **Load lysate·centrifuge** = lysate가 silica를 통과하며 cation bridge로 **핵산 흡착 완성**.\n→ 즉 cation bridge(흡착)는 **②③ 단계에서 형성**된다.\n\n**다른 단계 특징 (영어 선지 매칭 키)**\n- ① Lysis Buffer·vortex = **세포 용해(lysis)** — 흡착 아님.\n- ④ Washing Buffer A = **세척**(불순물 제거, 핵산은 붙은 채 유지).\n- ⑤ Re-place·centrifuge to **dry the membrane** = 🔴 **공회전** (잔류 ethanol이 downstream 방해 → 막 건조).\n- ⑥ Elution Buffer(low salt) = 🔴 **cation bridge 해제 → 용출**.\n\n**한 줄**: 흡착(cation bridge)=②③, 공회전=⑤, 해제=⑥. (강의안 RNA Extraction Protocol 영문 슬라이드)`,
 exam:'2025-기말', hl2025:true, freq:1, source:'jokbo'},
