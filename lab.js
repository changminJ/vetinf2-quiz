...
핵심: **1)역전사 → 2)RNase H로 RNA 제거 → 3)PCR**. (강의안 'RT-PCR' 3단계 슬라이드)`,
 exam:'2025-기말', hl2025:true, freq:1, source:'jokbo'},
{id:46, part:'RNA추출', topic:'Spin column 전체 protocol 영어 순서', origin:'concept', type:'essay',
 q:`Spin column을 이용한 RNA 추출의 **전체 lab 순서를 영어로** 순서대로 쓰시오. (정창민 자작)`,
 choices:[], answer:[],
 ...
 exam:'정창민 자작', freq:1, source:'정창민자작'},
{id:47, part:'RNA추출', topic:'영어 단계에서 cation bridge 생성~해제 구간', origin:'concept', type:'multi',
 q:`다음은 spin column RNA 추출 protocol의 **영어 단계**다. 이 중 **cation bridge가 생성되어 핵산이 silica에 결합했다가 해제될 때까지 — cation bridge가 관여하는 모든 단계**를 고르시오. (정창민 자작)`,
 ...
 exam:'정창민 자작', freq:1, source:'정창민자작'},
{id:48, part:'RNA추출', topic:'Lysis·Silica 흡착 시점 찾기', origin:'concept', type:'essay',
